...
include("../conexion/conexion.php");
    ...
    if(isset($_POST['queryString'])) {
            ...
            if(strlen($queryString) >0) {
                ...
                $query = $conn->query("SELECT CLIENTE_ID,CLIENTE_NOMBRE,CLIENTE_APELLIDO FROM cliente WHERE CLIENTE_ID LIKE '%".$queryString."%' GROUP BY CLIENTE_ID ORDER BY CLIENTE_ID ASC");
                if($query) {
                echo '<ul>';
